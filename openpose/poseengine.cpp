...
namespace op {
	...
	{
		std::string prototxt_file = "I:/Develop/caffe/OpenPose-new/pose_deploy_linevec.prototxt";
		std::string caffemodel_file = "I:/Develop/caffe/OpenPose-new/pose_iter_440000.caffemodel";
